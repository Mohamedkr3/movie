      ...
      <>
        ...
        <section className="my-5  py-5">
          <div className="container">
              ...
              <h2 className="fw-bold fs-1 text-capitalize pb-2">Top Rated movies</h2>
              </div>
            <div className="row pt-5 g-4">
             {
              topRatedMovies.length >=1?( topRatedMovies.slice(8,16).map((movie ,index)=>{
                  return(
