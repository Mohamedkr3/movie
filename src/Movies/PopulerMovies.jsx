...
export const PopularMovies = () => {
  const { populerMovies } = useContext(MoviesContext);
  return (
    <>
      ...
      <section className="my-5  py-5">
        <div className="container">
          <div className=" main-title-head position-relative">
            <h2 className="fw-bold fs-1 text-capitalize pb-2">
              Popular movies
            </h2>
          </div>
          <div className="row pt-5 g-4">
            {populerMovies.length >= 1
              ? populerMovies.slice(0, 8).map((movie, index) => {
                  return (
                    <div
